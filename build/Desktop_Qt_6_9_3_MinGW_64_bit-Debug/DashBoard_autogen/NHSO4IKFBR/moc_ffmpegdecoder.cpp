...
#include "../../../../include/backend/ffmpegdecoder.h"
...
void FFmpegDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (FFmpegDecoder::*)(const QImage & )>(_a, &FFmpegDecoder::frameReady, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (FFmpegDecoder::*)(int )>(_a, &FFmpegDecoder::stateChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (FFmpegDecoder::*)(const QString & )>(_a, &FFmpegDecoder::errorOccurred, 2))
            return;
    }
}
...
// SIGNAL 0
void FFmpegDecoder::frameReady(const QImage & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void FFmpegDecoder::stateChanged(int _t1)
{
